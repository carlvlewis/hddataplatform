...
***************************************************************************/
	...
	DEFINE("PROJECTTHEME_VERSION", "2.0.9.12");
	DEFINE("PROJECTTHEME_RELEASE", "4 Oct 2016");
	...
	?>
	 <div class="user-table-row">
		<div class="user-table-user-avatar">
        		<img src="<?php echo ProjectTheme_get_avatar($uid,95, 95) ?>" alt="avatar-user" class="acc_m1" width="95" height="95" />
        </div>
        ...
        <div class="user-table-user-info">
            	...
            	<ul>
                	<li><a class="avatar-posted-by-username" href="<?php bloginfo('url'); ?>/?p_action=user_profile&post_author=<?php echo $uid; ?>"><?php echo $author_info->user_login ?></a></li>
...
function ProjectTheme_add_max_nr_of_images()
{
	...
	jQuery( document ).ready(function() {
		...
		jQuery("#submit-proposal-id").fancybox({
				...
				'padding'           : 0,
				'centerOnScroll'    : true,
				'href'              : '<?php bloginfo('url') ?>/?<?php echo $get_bidding_panel ?>=1&pid=' + pid,
				'type'              : 'ajax'
		...
		jQuery(".message_brd_cls").fancybox({
				...
				'padding'           : 0,
				'centerOnScroll'    : true,
				'href'              : '<?php bloginfo('url') ?>/?get_message_board=' + pid,
				'type'              : 'ajax'
...
function projectTheme_get_the_search_box($ff = '')
{
    ...
    <form method="post" action="<?php bloginfo('url') ?>/?redirect_search=1">
...
function ProjectTheme_get_users_links()
{
	...
	<div id="right-sidebar" class="account-sidebar">
            ...
            <ul id="my-account-admin-menu">
                ...
                <li><a href="<?php echo get_permalink(get_option('ProjectTheme_my_account_workspaces_id')); ?>"><?php echo sprintf(__("Workspaces %s",'ProjectTheme'),$ssk);?></a></li>
			...
			?>
            <li class="widget-container widget_text"><h3 class="widget-title"><?php _e("Freelancer Menu",'ProjectTheme'); ?></h3>
			<p>
			<?php
...
?>
 ...
 var $ = jQuery;
     ...
     jQuery(function() {
		...
		var SITE_URL = '<?php bloginfo('home'); ?>';
...
{
	return get_bloginfo('url'). '/?p_action=user_feedback&post_author='. $uid;
}
...
function ProjectTheme_get_user_profile_link($uid)
{
	if(ProjectTheme_using_permalinks() == true)
	{
		...
		return get_bloginfo('url'). '/user-profile/'. urlencode($user_login->user_login);
	}
	else return get_bloginfo('url'). '/?p_action=user_profile&post_author='. $uid;
}
...
?>
                ...
                <div class="title_holder" >
                  ...
                  <a href="<?php bloginfo('url') ?>/?p_action=edit_project&pid=<?php the_ID(); ?>" class="post_bid_btn"><?php echo __("Edit Project", "ProjectTheme");?></a>
                  <?php }   ?>
				  ...
				  { ?>
                  <a href="<?php bloginfo('url') ?>/?p_action=repost_project&pid=<?php the_ID(); ?>" class="post_bid_btn"><?php echo __("Repost Project", "ProjectTheme");?></a>
                ...
                <?php
					...
					if(empty($winner)):
					?>
                   <a href="<?php bloginfo('url') ?>/?p_action=delete_project&pid=<?php the_ID(); ?>" class="post_bid_btn"><?php echo __("Delete", "ProjectTheme");?></a>
        ...
        <div class="post" id="post-<?php the_ID(); ?>"><div class="padd10">
            ...
            <div class="excerpt-thing">
                        ...
                        <?php
							...
							if($projectTheme_enable_paypal_ad == "yes")
							{
								...
								?>
                                	...
                                	<a href="<?php bloginfo('url'); ?>/?p_action=pay_for_project_paypal&pid=<?php echo get_the_ID(); ?>" class="green_btn"><?php _e('Deposit PayPal Escrow','ProjectTheme') ?></a>
                   ...
                   <?php _e('Accept this project and: ','ProjectTheme'); ?>
                     <a href="<?php echo get_bloginfo('url'); ?>/?p_action=mark_completed&pid=<?php the_ID(); ?>"
        ...
        <div class="post" id="post-<?php the_ID(); ?>"><div class="padd10">
            ...
            <div class="excerpt-thing">
                ...
                <div class="my-deliv_2">
				  ...
				  <?php if($post->post_author == $uid) { ?>
                  <a href="<?php bloginfo('url') ?>/?p_action=edit_project&pid=<?php the_ID(); ?>" class="green_btn3"><?php echo __("Edit Project", "ProjectTheme");?></a>
                  <?php }   ?>
				  ...
				  { ?>
                   ...
                   <?php if($closed == "1") //$closed == 1)
				  { ?>
                  <a href="<?php bloginfo('url') ?>/?p_action=repost_project&pid=<?php the_ID(); ?>" class="green_btn3"><?php echo __("Repost Project", "ProjectTheme");?></a>
                  ...
                  <?php } /*} else { */  ?>
					...
					if(empty($winner)):
					?>
                   <a href="<?php bloginfo('url') ?>/?p_action=delete_project&pid=<?php the_ID(); ?>" class="green_btn3"><?php echo __("Delete", "ProjectTheme");?></a>
                  <?php endif; ?>
            ...
            <div class="excerpt-thing">
                ...
                <div class="my-deliv_2">
						...
						?>
                            ...
                            <a href="<?php echo get_bloginfo('url'); ?>/?p_action=mark_delivered&pid=<?php the_ID(); ?>"
					...
					if($projecttheme_escrow_was_made_for_project_not_released == false):
						...
						if($adaptive_done == "started")
						{
							?>
                            	 ...
                            	 <a href="<?php echo get_bloginfo('url'); ?>/?complete_paypal_escrow=<?php the_ID() ?>" class="green_btn"><?php echo __("Complete PayPal Escrow Payment", "ProjectTheme");?></a>
...
function ProjectTheme_post_new_with_pid_stuff_thg($pid, $step = 1, $fin = 'no')
{
	...
	else return get_bloginfo('url'). "/?page_id=". get_option('ProjectTheme_post_new_page_id'). "&".($fin != "no" ? 'finalize=1&' : '' )."post_new_step=".$step."&projectid=" . $pid;
}
...
if($_POST['redirect_search'] == "freelancers")
		...
		if($ProjectTheme_enable_2_user_tp == "yes" && $p_action != 'choose_user_tp')
		{
			if(is_user_logged_in())
			{
				...
				{
					wp_redirect(get_bloginfo('url') . "/?p_action=choose_user_tp"); exit;
				}
		...
		if($my_pid == $ProjectTheme_post_new_page_id)
		{
			...
			if(!ProjectTheme_is_user_business($current_user->ID)) { wp_redirect(get_bloginfo('url')); exit; }
	...
	if(empty($opt))
	{
		...
		foreach($r as $row):
			...
			if($enable != "no"):
				...
				$replace 	= array($user->user_login, $user->user_email, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $post->post_title, get_permalink($pid));
...
function ProjectTheme_send_email_on_completed_project_to_bidder($pid, $bidder_id)
{
	...
	if($enable != "no"):
		...
		$find 		= array('##username##', '##site_login_url##', '##your_site_name##', '##your_site_url##' , '##my_account_url##', '##project_name##', '##project_link##');
   		$replace 	= array($user->user_login, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $post->post_title, get_permalink($pid));
...
function ProjectTheme_send_email_on_escrow_project_to_bidder2($pid, $bidder_id, $es)
{
	...
	if($enable != "no"):
		...
		$find 		= array('##username##', '##site_login_url##', '##your_site_name##', '##your_site_url##' , '##my_account_url##', '##project_name##', '##project_link##', '##escrow_amount##');
   		$replace 	= array($user->user_login, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $post->post_title, get_permalink($pid), $es);
...
function ProjectTheme_send_email_on_message_board_owner($pid, $owner_id, $sender_id)
{
	...
	if($enable != "no"):
		...
		$find 		= array('##username##', '##message_owner_username##', '##site_login_url##', '##your_site_name##', '##your_site_url##' , '##my_account_url##','##project_name##','##project_link##');
   		$replace 	= array($owner_id->user_login, $sender_id->user_login, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $project->post_title, get_permalink($pid));
...
function ProjectTheme_send_email_on_win_to_bidder($pid, $winner_uid)
{
	...
	if($enable != "no"):
		...
		$find 		= array('##username##', '##username_email##', '##site_login_url##', '##your_site_name##', '##your_site_url##' , '##my_account_url##', '##project_name##', '##project_link##','##winner_bid_value##');
   		$replace 	= array($user->user_login, $user->user_email, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $post->post_title, get_permalink($pid), $winner_bid_value);
...
function ProjectTheme_send_email_when_bid_project_bidder($pid, $uid, $bid)
{
	...
	if($enable != "no"):
		...
		$find 		= array('##username##', '##site_login_url##', '##your_site_name##', '##your_site_url##' , '##my_account_url##', '##project_name##', '##project_link##', '##bid_value##');
   		$replace 	= array($user->user_login, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $post->post_title, get_permalink($pid), $bid_val );
...
function ProjectTheme_send_email_when_bid_project_owner($pid, $uid, $bid)
{
	...
	if($enable != "no"):
		...
		$find 		= array('##username##', '##bid_value##', '##site_login_url##', '##your_site_name##', '##your_site_url##' , '##my_account_url##', '##project_name##', '##project_link##', '##bidder_username##');
   		$replace 	= array($user->user_login, $bid_val, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $post->post_title, get_permalink($pid), $bidder_username);
...
function ProjectTheme_send_email_posted_project_not_approved($pid)
{
	...
	if($enable != "no" and empty($opt)):
		...
		$find 		= array('##username##', '##username_email##', '##site_login_url##', '##your_site_name##', '##your_site_url##' , '##my_account_url##', '##project_name##', '##project_link##');
   		$replace 	= array($user->user_login, $user->user_email, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $project_name, get_permalink($pid));
...
function ProjectTheme_send_email_posted_project_approved($pid)
{
	...
	if($enable != "no" and empty($opt)):
		...
		$find 		= array('##username##', '##username_email##', '##site_login_url##', '##your_site_name##', '##your_site_url##' , '##my_account_url##', '##project_name##', '##project_link##');
   		$replace 	= array($user->user_login, $user->user_email, $site_login_url, $site_name, get_bloginfo('url'), $account_url, $project_name, $project_link);
...
function projectTheme_send_email_to_project_payer($pid, $payer_user_id, $receiver_user_id, $amount, $pay_by_credits = '0')
{
	...
	if($pay_by_credits == '1'):
		...
		$uprof 	= ProjectTheme_get_user_profile_link($receiver_user->ID); //get_bloginfo('url')."/user-profile/".$receiver_user->user_login;
			...
			if(empty($messid))
			{
				foreach($_GET['message_id'] as $messid)
				{
					...
					if(count($r) > 0)
					{
						...
						else $privurl_m = get_bloginfo('url'). "/?page_id=". get_option('ProjectTheme_my_account_private_messages_id'). "&";
