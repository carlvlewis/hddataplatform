<?php
	...
	$cancel_url 	= get_bloginfo("url").'/?p_action=mb_listing_response&pid='.$pid;
	$response_url 	= get_bloginfo('url').'/?p_action=mb_listing_response';
	$ccnt_url		= get_bloginfo('url').'/?p_action=edit_project&paid=ok&pid=' . $pid;
