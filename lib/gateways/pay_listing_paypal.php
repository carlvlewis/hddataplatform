...
//--------------------------------------------------------------------------------
	...
	global $wpdb;
	$this_script = get_bloginfo('url').'/?jb_action=pay_featured&method=paypal&jobid='.$pid;
   ...
   case 'process':      // Process and order...
			...
			//---------------------------------------------------
			  ...
			  $p->add_field('notify_url', get_bloginfo('url').'/?payment_response_listing=paypal');
   ...
   case 'cancel':       // Order was canceled...
	...
	wp_redirect(get_bloginfo("url").'/?page_id='.$pstn.'&jobid='.$pid);
