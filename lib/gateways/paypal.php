...
//--------------------------------------------------------------------------------
	...
	global $wpdb;
	$this_script = get_bloginfo('url').'/?pay_for_item=paypal&jobid='.$pid;
   ...
   case 'process':      // Process and order...
			...
			//---------------------------------------------------
			  ...
			  $p->add_field('notify_url', get_bloginfo('url').'/?payment_response=paypal_response');
   ...
   case 'success':      // Order was successful...
	...
	wp_redirect(get_permalink(get_option('PricerrTheme_my_account_shopping_page_id'))); //('url')."/my-account/shopping/");
