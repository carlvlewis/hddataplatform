...
<div id="content" class="account-main-area">
        ...
        <div class="my_box3">
				...
				function on_proj_sel()
				{
					...
					$.post("<?php bloginfo('url'); ?>/?get_my_project_vl_thing=1", {queryString: ""+sel_value+""}, function(data){
						if(data.length >0) {
        ...
        <div class="my_box3">
                ...
                <form method="post" action="<?php bloginfo('url'); ?>/?p_action=paypal_deposit_pay">
                ...
                <form method="post" action="<?php bloginfo('url'); ?>/?p_action=payza_deposit_pay">
                <?php _e("Amount to deposit:","ProjectTheme"); ?> <input type="text" size="10" name="amount" /> <?php echo projectTheme_currency(); ?>
                &nbsp; &nbsp; <input type="submit" name="deposit" value="<?php _e('Deposit','ProjectTheme'); ?>" /></form>
    			<br/><br/>
                <?php endif; ?>
                ...
                <form method="post" action="<?php bloginfo('url'); ?>/?p_action=mb_deposit_pay">
                <?php _e("Amount to deposit:","ProjectTheme"); ?>  <input type="text" size="10" name="amount" /> <?php echo projectTheme_currency(); ?>
                &nbsp; &nbsp; <input type="submit" name="deposit" value="<?php _e('Deposit','ProjectTheme'); ?>" /></form>
    			<br/><br/>
                <?php endif; ?>
