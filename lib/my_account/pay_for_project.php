    ...
    <div id="content" class="account-main-area">
            ...
            <div class="my_box3 ">
			 ...
			 echo __('You are about to pay for this project. Use the accepted methods below to pay for it.','ProjectTheme'); ?>
                ...
                <a href="<?php bloginfo('url'); ?>/?p_action=pay_for_project_paypal&pid=<?php echo $pid; ?>"><img src="<?php echo get_bloginfo('template_url'); ?>/images/paypal.jpg" border="0" /></a><br/><br/>
